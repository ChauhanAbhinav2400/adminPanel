...
import { addTags, editTag } from '../ApiListener/tagsApi';
...
export default function EditTag() {
  ...
  const userInfo = JSON.parse(localStorage.getItem("userinfo"));
    ...
    const notify = () => toast.success("Tag Successfully Update", {
      position: "top-right",
      autoClose: 5000,
      ...
      <section className='bg-[#f1f5f9]	 mt-4 mx-4 flex flex-row	justify-between items-center  '>
        <div className='mt-3 ms-3'>
          ...
          <div className='my-2  flex gap-x-4 justify-center items-center'>
            <i ><FaArrowLeftLong /></i>
            <div className='font-semibold text-lg'>Edit Tag</div>
          </div>
        </div>
