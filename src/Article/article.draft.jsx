...
import { getDraftArticleById } from "../redux/actions/action.edit";
import { toast } from "react-toastify";
import { getDraftArtical } from "../ApiListener";
...
const DraftArticles = () => {
  ...
  const handleEdit = (id) => {
    dispatch(getDraftArticleById(id));
        ...
        <div className="w-full flex justify-between">
          ...
          <div className="flex justify-center items-center gap-6">
            ...
            >
              ...
              {[
                ...new Set(
                  draftArticle.map((article) => article.createdDt?.slice(0, 11))
                ),
              ].map((date) => (
