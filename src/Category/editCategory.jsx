...
import { addCategory, editCategory } from "../ApiListener/categoryApi";
...
export default function EditCategory() {
  ...
  const notify = () =>
    toast.success("Successfully category Update", {
      position: "top-right",
      autoClose: 5000,
  ...
  const saveCategoryHandler = (e) => {
    ...
    addCategory(formData).then((resp) => {
      ...
      nevigate ("/admin/category/create")
    });
  };

  useEffect(()=>{
    editCategory(id).then((resp)=>{
      setFormData(resp)
    })
},[])
      ...
      <section className="bg-[#f1f5f9]	 mt-4 mx-4 flex flex-row	justify-between items-center  ">
        <div className="mt-3 ms-3">
          ...
          <div className="my-2  flex gap-x-4 justify-start items-center">
            ...
            <div className="font-semibold text-lg">Edit Category</div>
          </div>
        </div>
      ...
      <div className="mx-3  ">
        ...
        <div>
          ...
          <input
            type="text"
            name="slugUrl"
            placeholder="Set Priority Order"
